        ...
        try {
            ...
            for (i = 0; i < actionList.size(); i++) {
                ...
                if (actionName.equals(path2)) {
                    ...
                    Method actionMethod = actionClass.getMethod(action.attributeValue("method"), String.class, String.class);
                    ...
                    String actionResult = (String) actionMethod.invoke(actionProxy, userName, password);
